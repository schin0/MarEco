...
import br.com.fiap.mareco.components.MostrarToastSucesso
...
@Composable
fun TelaCoralReport(navController: NavController) {
    ...
    Column(
        ...
        Column(
            modifier = Modifier
                .fillMaxWidth()
                .padding(top = 22.dp),
            verticalArrangement = Arrangement.spacedBy(10.dp) // Espaçamento vertical entre os elementos
            ...
            // Interface do usuário que exibe um TextField e um dropdown menu
            Column(
                modifier = Modifier
                    .fillMaxWidth(),
                ...
                // Campo de texto que abre o menu dropdown
                TextField(
